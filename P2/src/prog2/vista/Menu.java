...
/**
 * Implementa un menú de text usant una llista d'opcions
 * @author Xavi Baró
 */
    ...
    public TEnum getOpcio(Scanner sc) {
        ...
        do {
            do {
                ...
                try {
                    opcioInt = sc.nextInt();
                    if (opcioInt == -1) System.err.println("La opció seleccionada no és correcta. Selecciona una opció entre 1 i " + (_llistaOpcions.length));
                } catch (Exception e) {
